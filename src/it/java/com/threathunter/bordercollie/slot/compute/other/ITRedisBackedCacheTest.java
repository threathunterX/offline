package com.threathunter.bordercollie.slot.compute.other;
 ...
 */
public class ITRedisBackedCacheTest {

    @Rule
    public GenericContainer redis = new GenericContainer("daocloud.io/redis:4.0")
    ...
    public void setUp() throws Exception {
        ...
        cache = new ITRedisBackedCache(jedis, "test");
    }
