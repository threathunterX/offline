...
public class JsonFileReader {
    ...
    public static List<Map<String, Object>> getValuesFromFile(String file, ClassType type) throws IOException {
        if (type == ClassType.MAP) {
            Map<String, Object> map = getFromResourceFile(file, Map.class);
            return (List<Map<String, Object>>) map.get("values");
    ...
    public static List<VariableMeta> getVariableMetas(String file, ClassType type) throws IOException {
        List<Map<String, Object>> values = JsonFileReader.getValuesFromFile(file, type);
